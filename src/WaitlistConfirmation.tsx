...
const WaitlistConfirmation: React.FC<WaitlistConfirmationProps> = ({ onClose }) => {
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-brand-cream text-brand-purple font-sans text-base leading-base">
      <div className="flex flex-col items-center w-full max-w-2xl px-4">
        ...
        <button
          onClick={onClose}
          className="px-6 py-2 bg-brand-purple hover:bg-opacity-90 rounded-full text-white font-semibold transition duration-300 ease-in-out"
        >
          Back to Home
        </button>
      </div>
